...
This lane went quiet and never reported, so spoolway tore it down and put
the task back here. Nothing failed a check. The last `## Status Log` entry
in {task_file} says why. Same session: read it, then carry on.
