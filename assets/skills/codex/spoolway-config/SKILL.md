...
to read and prints this project's preferences — take those as answered
rather than asking again, and set every loop the file ends up with to the
`loop_default` it names.
