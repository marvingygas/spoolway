...
/// under, the steps a `gate_at` may name, which of them are `last-of-chain`
/// and `first-of-chain`, this pipeline's own `description:`, and the body a
/// task on it is written from.
#[derive(Debug, serde::Serialize)]
