...
once in a file. A background dispatcher moves every task through it, in terminal panes or
headless processes, and asks you only where a decision is yours.
...
| [The dispatcher](dispatcher.md) | The board, scheduling, gates, backends, stepping into a lane |
